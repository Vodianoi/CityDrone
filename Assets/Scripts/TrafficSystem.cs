...
namespace  Kawaiiju.Traffic
{
	...
	public class TrafficSystem : MonoBehaviour 
	{
		...
		public List<GameObject> vehiclePrefabs; // TODO - Get from object pool
		...
		private void SpawnRoadVehicle(bool reset)
		{
			...
			Vehicle newVehicle = Instantiate(vehiclePrefabs[UnityEngine.Random.Range(0, vehiclePrefabs.Count)], spawn.spawn.position, spawn.spawn.rotation, pool.transform).GetComponent<Vehicle>();
